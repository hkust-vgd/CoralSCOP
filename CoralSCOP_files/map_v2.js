...
/* date last modified: 2024-03-21 16:43:25 */
...
function main() {
  /* The main logic of our widget */
    ...
    function adjustElements(data) {
        ...
        // modify show visitors only
        $('.clustrmaps-date').hide();
        $('.clustrmaps-map').hide();
        $('.clustrmaps-map-container').css('background-color', 'white');
        $('.clustrmaps-visitors').css('color','gray')
    }
